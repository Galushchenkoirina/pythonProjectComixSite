        ...
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div>
                    <label>
                        Способ оплаты:
                        <select name="payment_method" value={customerData.payment_method} onChange={handleChange}>
                ...
                <div>
                    <label>
                        Способ доставки:
                        <select name="delivery_method" value={customerData.delivery_method} onChange={handleChange}
                                required>
